package com.goropai.recipe.bootstrap;

import com.goropai.recipe.domain.*;
import com.goropai.recipe.repositories.CategoryRepository;
import com.goropai.recipe.repositories.RecipeRepository;
import com.goropai.recipe.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>{
    ...
    private List<Recipe> getRecipes() {
        ...
        if (!eachUomOptional.isPresent()) {
            throw new RuntimeException("UOM type not found");
        }
        ...
        guacNote.setRecipeNote("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
                "\n" +
